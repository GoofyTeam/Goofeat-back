...
async function testSearch() {
  ...
  // Forcer la recréation de l'index et le re-seeding complet
  console.log("--- Étape 1: Recréation de l'index Elasticsearch ---");
  console.log('--- Étape 2: Lancement du seeding complet... ---');
