...
@ApiTags('Profil Utilisateur V1 (Legacy)')
...
export class UserProfileV1Controller {
  ...
  @ApiOperation({
    ...
    description:
      '⚠️ API V1 - Deprecated. Utilisez les endpoints spécialisés de la V2 pour plus de granularité.',
  })
  @ApiBody({ type: UpdateProfileV1Dto })
  @ApiResponse({
    status: 200,
  ...
  async updateProfile(
    ...
    @Body() updateProfileDto: UpdateProfileV1Dto,
  ) {
